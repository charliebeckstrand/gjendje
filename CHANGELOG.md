...
- Optimize `readonly()`: use bound method references instead of wrapper functions for `get`, `peek`, `subscribe`, and `destroy`. Reduces overhead from ~37% to ~20% vs direct access.
