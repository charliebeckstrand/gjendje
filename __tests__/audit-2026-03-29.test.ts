...
// Tests for findings 9-11 have been moved to their applicable test files:
// - Finding 9 (previous NaN equality) → previous.test.ts
// - Finding 10 (reset callback order) → configure.test.ts
// - Finding 11 (persist notification) → persist-selective.test.ts
