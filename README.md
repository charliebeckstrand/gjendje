...
Every app juggles localStorage, URL params, sessionStorage, and in-memory state. **gjendje** replaces that and more with a unified API. Choose where state lives. The rest is handled.
